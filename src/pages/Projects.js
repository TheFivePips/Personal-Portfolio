  ...
  return (
    <div>
      ...
      <Project
        title="StrykThru"
        src={StrykThru}
        summary="This is a pure Javascript todo app that allows the user to add, edit, or delete project folders. Users can also create new tasks with due-dates and priorities."
        tech={[
          "JavaScript",
          "date-fns",
          "Webpack",
